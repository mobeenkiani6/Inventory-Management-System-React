                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      ...
                      <Menu as="div" className="relative ml-3">
                        ...
                        >
                          <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md glass-effect border border-slate-700/50 py-1 shadow-lg focus:outline-none">
                                ...
                                {({ active }) => (
                                  <Link
                                    ...
                                    className={classNames(
                                      ...
                                      "block px-4 py-2 text-sm text-slate-200 hover:text-white transition-colors"
                                    )}
                                  >
